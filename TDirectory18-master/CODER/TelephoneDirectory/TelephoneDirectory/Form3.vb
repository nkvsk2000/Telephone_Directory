...
Public Class Form3
    ...
    Private Sub Form3_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        ...
        Panel11.Location = New Point((Me.Width - Panel3.Width - Panel11.Width) / 2, 200)
        Panel5.Location = New Point((Me.Width - Panel3.Width - Panel5.Width) / 2, 200)
        Panel14.Location = New Point((Me.Width - Panel3.Width - Panel14.Width) / 2, 200)

        Panel16.Location = New Point((Me.Width - Panel3.Width - Panel16.Width) / 2, 60)
        Panel9.Location = New Point((Me.Width - Panel3.Width - Panel9.Width) / 2, 60)
        Panel10.Location = New Point((Me.Width - Panel3.Width - Panel10.Width) / 2, 60)
